export { Format, FormatDefinition, AsyncFormatDefinition, KeywordDefinition, KeywordErrorDefinition, CodeKeywordDefinition, MacroKeywordDefinition, FuncKeywordDefinition, Vocabulary, Schema, SchemaObject, AnySchemaObject, AsyncSchema, AnySchema, ValidateFunction, AsyncValidateFunction, AnyValidateFunction, ErrorObject, ErrorNoParams, } from "dist/types";
export { SchemaCxt, SchemaObjCxt } from "dist/compile";
export interface Plugin<Opts> {
    (ajv: Ajv, options?: Opts): Ajv;
    [prop: string]: any;
}
export { KeywordCxt } from "dist/compile/validate";
export { DefinedError } from "dist/vocabularies/errors";
export { JSONType } from "dist/compile/rules";
...
export { _, str, stringify, nil, Name, Code, CodeGen, CodeGenOptions } from "dist/compile/codegen";
import type { Schema, AnySchema, AnySchemaObject, SchemaObject, AsyncSchema, Vocabulary, KeywordDefinition, AddedKeywordDefinition, AnyValidateFunction, ValidateFunction, AsyncValidateFunction, ErrorObject, Format, AddedFormat, RegExpEngine, UriResolver } from "dist/types";
...
import ValidationError from "dist/runtime/validation_error";
import MissingRefError from "dist/compile/ref_error";
import { ValidationRules } from "dist/compile/rules";
import { SchemaEnv } from "dist/compile";
import { Code, ValueScope } from "dist/compile/codegen";
